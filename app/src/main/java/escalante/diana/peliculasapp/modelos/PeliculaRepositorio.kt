...
class PeliculaRepositorio {
    private val peliculas = mutableListOf(
        ...
        Pelicula(3, "Minions", "Comedia", "1h 31min", "Los Minions, criaturas amarillas dedicadas a servir al villano más malvado, viajan por el mundo en busca de un nuevo líder, encontrando finalmente a Scarlet Overkill, quien planea dominar el mundo.", R.drawable.minionsposter),
        Pelicula(4, "Iron Man", "Acción", "2h 6min", "El multimillonario e ingeniero Tony Stark construye una armadura avanzada para escapar del cautiverio y luego decide usar su tecnología para convertirse en el héroe conocido como Iron Man.", R.drawable.ironmanposter),
